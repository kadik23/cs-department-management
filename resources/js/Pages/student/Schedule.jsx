...
export default function Schedule({ student, schedule, settings }) {
    ...
    return (
        <div className="page-content">
            <div className="page-header">
                <div className="page-title">Schudeler</div>
            </div>
                                        ...
                                        {cell ? (
                                            <>
                                                ...
                                                <div className="class_info">
                                                    <div className="teacher_name">{cell.teacher?.user?.first_name} {cell.teacher?.user?.last_name}</div>
...
Schedule.layout = page => <StudentLayout>{page}</StudentLayout>; 